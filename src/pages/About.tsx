      ...
      <section className="section-padding bg-card/50">
        <div className="container mx-auto grid md:grid-cols-2 gap-8">
          <div className="glass rounded-xl p-8">
            ...
            <h2 className="text-2xl font-heading font-bold mb-4 text-foreground">Notre Mission</h2>
          ...
          <div className="glass rounded-xl p-8">
            ...
            <h2 className="text-2xl font-heading font-bold mb-4 text-foreground">Notre Vision</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            {[
              {
                icon: Heart,
                title: "Impact",
                desc: "Chaque projet doit créer de la valeur mesurable pour nos clients et leur écosystème.",
              },
              {
                icon: Globe,
                title: "Accessibilité",
                desc: "Nous rendons l'IA compréhensible et accessible, même pour les non-techniciens.",
              },
              {
                icon: Award,
                title: "Excellence",
                desc: "Nous visons la qualité et l'innovation dans chaque solution que nous déployons.",
              },
            ].map((v) => (
              <div key={v.title} className="glass rounded-xl p-8 text-center hover:border-primary/40 transition-all">
                <v.icon size={32} className="text-primary mx-auto mb-4" />
                <h3 className="font-heading font-semibold text-lg mb-3 text-foreground">{v.title}</h3>
